...
// Define Account (Subclass of AccountInterface)
Account::Account(ServiceFeesInterface* serviceFees)
...
// Methods
std::string Account::deposit(const double& amount) {
	std::cout << "DEPOSIT" << std::endl;
	return (*m_currentState).deposit(amount);
}

std::string Account::withdraw(const double& amount) {
...
void Account::setUpLockState(State* lockState) {
	m_lockState = lockState;
	m_currentState = m_lockState;
}

void Account::setUpNormalState(State* normalState) {
	m_normalState = normalState;
}

void Account::increaseBalance(const double& newBalance) {
	m_balance += newBalance;
}

void Account::deductBalance(const double& newBalance) {
	m_balance -= newBalance;
}

State* Account::getNormalState() {
	return m_normalState;
}

State* Account::getLockState() {
	return m_lockState;
}
...
double Account::getServiceCharge(const double& amount) {
...
//#include "Accout.h"
//#include "State.h"
//////#include "AccoutInterface.h"
//#include "ServiceFeesInterface.h"

//class State;
//class AccoutInterface;
